				...
				<div class="col-sm-9">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                        <div class="navbar-nav">
                           ...
                           <a class="nav-item nav-link" href="collection.html">Tienda</a>
                           ...
                           <a class="btn btn-primary" href="registro.html">Inicio Sesión</a>
...
<input type="submit" value="Cerrar sesión" name="btncerrar" />
        ...
        <div id="sfcnc2f1q592c388e3xh668p3y57r89jbsu"></div>
<script type="text/javascript" src="https://counter7.stat.ovh/private/counter.js?c=nc2f1q592c388e3xh668p3y57r89jbsu&down=async" async></script>
<br><a href="https://www.freecounterstat.com">Número de visitas</a><noscript><a href="https://www.freecounterstat.com" title="web hit counter"><img src="https://counter7.stat.ovh/private/freecounterstat.php?c=nc2f1q592c388e3xh668p3y57r89jbsu" border="0" title="web hit counter" alt="web hit counter"></a></noscript>
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
					...
					<div class="col-sm-2 padding_0">
						<p class="mens_taital">Men Jeans</p>
						<div class="page_no">1/4</div>
						<p class="mens_taital_2">Men Jeans</p>
					</div>
					<div class="col-sm-5">
						<div class="banner_taital">
							<h1 class="banner_text">Vista casual </h1>
							<h1 class="mens_text"><strong>Para hombres con estilo</strong></h1>
							...
							<button class="buy_bt">Comprar</button>
							<button class="more_bt">Ver más</button>
						</div>
					</div>
					<div class="col-sm-5">
						<div class="shoes_img"><img src="images/running-shoes.jpg"></div>
					</div>
				</div>
                </div>
    	...
    	<div class="container">
    		<div class="mail_section">
    			<div class="row">
    				...
    				<div class="col-sm-6 col-lg-2">
    					<div class="footer-logo"><img src="images/phone-icon.png"><span class="map_text">(+52) 722 622 8589</span></div>
    				</div>
